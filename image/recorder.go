...
type Recorder interface {
	// Events returns a channel from which ImageEvents can be read, each
	// containing an image.
	Events() chan Event

	// Close shuts down the image recorder. No further ImageEvents will be
	// sent.
	Close() error
}
